...
BOT_IS_UP_TO_DATE = "**Tʜɘ 𝕊𝔸ℕ𝕂𝕀 𝔸𝕌𝕋𝕆𝔹𝕆𝕋** ɩs ʋp-to-ɗʌtɘ sɩʀ ."
NEW_BOT_UP_DATE_FOUND = (
    "ŋɘw ʋpɗʌtɘ ʆoʋŋɗ for {branch_name}\n"
    "cʜʌŋʛɘɭoʛ : \n\n{changelog}\n"
    "ʋpɗʌtɩŋʛ ƴoʋʀ 𝕊𝔸ℕ𝕂𝕀 𝔸𝕌𝕋𝕆𝔹𝕆𝕋 ..."
)
NEW_UP_DATE_FOUND = "New update found for {branch_name}\n" "`updating your 𝕊𝔸ℕ𝕂𝕀 𝔸𝕌𝕋𝕆𝔹𝕆𝕋...`"
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("`Upɗʌtɩoŋ ɩŋ Pʀoʛʀɘss......`")
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit(
        "Upɗʌtɘɗ ƴoʋʀ 𝕊𝔸ℕ𝕂𝕀 𝔸𝕌𝕋𝕆𝔹𝕆𝕋 sʋccɘssʆʋɭɭƴ sɩʀ!!!\nNow tƴpɘ `.ping` ʌʆtɘʀ 5 ɱɩŋs to cʜɘcĸ ɩʆ I'ɱ oŋ🚶😏"
    )
