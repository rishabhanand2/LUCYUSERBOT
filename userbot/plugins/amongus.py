...
async def _(event):
    ...
    text1 = await edit_or_reply(event, "Hɱɱ... Looĸs ɭɩĸɘ Soɱɘtʜɩŋʛ ɩs wʀoŋʛ ʜɘʀɘ🤔🧐!!")
    ...
    text2 = await event.reply(
        f"**[{DEFAULTUSER}]({USERNAME}) :** I ʜʌvɘ to cʌɭɭ ɗɩscʋssɩoŋ😯"
    )
    ...
    text3 = await event.reply(
        f"**[{DEFAULTUSER}]({USERNAME}) :** Wɘ ʜʌvɘ to ɘjɘct tʜɘ ɩɱpostɘʀ oʀ wɩɭɭ ɭosɘ😥 "
    )
    await asyncio.sleep(3)
    await stcr2.delete()
    await text3.delete()
    ...
    text4 = await event.reply(f"**Otʜɘʀs :** Wʜɘʀɘ ???🤨 ")
    await asyncio.sleep(2)
    await text4.edit(f"**Otʜɘʀs :** Wʜo ??🤔 ")
    await asyncio.sleep(2)
    await text4.edit(
        f"**[{DEFAULTUSER}]({USERNAME}) :** Its {name} , I sʌw {name}  ʋsɩŋʛ🤨 vɘŋt,"
    )
    await asyncio.sleep(3)
    await text4.edit(f"**Otʜɘʀs :**Oĸʌƴ.. 😲Votɘ {name} ")
    await asyncio.sleep(2)
    await stcr3.delete()
    await text4.delete()
    ...
    mafiaevent = await event.reply(f"{name} ɩs ɘjɘctɘɗ.......🤐")
    await asyncio.sleep(2)
...
async def _(event):
    ...
    name = event.pattern_match.group(2)
    cmd = event.pattern_match.group(1).lower()
    mafiaevent = await edit_or_reply(event, f"{name} ɩs ɘjɘctɘɗ.......")
    await asyncio.sleep(2)
    await mafiaevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
