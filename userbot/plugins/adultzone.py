...
async def boobs(event):
    ...
    a = await event.reply("Fɩŋɗɩŋʛ soɱɘ ɓɩʛ ɓooɓs ʆoʀ ʋ 🧐")
    await asyncio.sleep(0.5)
    await a.edit("Sɘŋɗɩŋʛ soɱɘ ɓɩʛ ɓooɓs 🤪")
...
async def butts(event):
    ...
    a = await event.reply("Fɩŋɗɩŋʛ soɱɘ ɓɘʌʋtɩʆʋɭ ɓʋtts ʆoʀ ʋ 🧐")
    await asyncio.sleep(0.5)
    await a.edit("Sɘŋɗɩŋʛ soɱɘ ɓɘʌʋtɩʆʋɭ ɓʋtts 🤪")
